...
public final class MonoscopicView extends GLSurfaceView {
  ...
  /**
   * Nonso: Duplication on Initialize Methode without Video UI View
   */
  ...
  /** Nonso: Pass Ui in Order to Use Scene for Multiple Intents */
  public void loadMedia(Intent intent, VideoUiView UiView){
    mediaLoader.handleIntent(intent, UiView);
  }

  /**
   * Nonso: Parses Intert and Loads media without UIView
   */
  public void loadOnlyMedia(Intent intent) {
  ...
  static class Renderer implements GLSurfaceView.Renderer {
    ...
    /* Nonso: Class Initialisation without Video Ui */
